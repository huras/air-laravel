    ...
    <div class="container-fluid px-4 pe-5">
        ...
        <div class="row pt-5 my-5">
            <div class="col-sm-12 col-md-4 col-lg-3 mb-4">
                ...
                <p class="pe-5 fs-20 small @yield('footer-text-theme', 'text-black')">
            ...
            <div class="col text-md-end">
                <svg width="87" height="51" viewBox="0 0 87 51" fill="none"
                    ...
                    <path
                        ...
                        fill="black" />
                    <path d="M58.0875 12.9551H50.314V49.6784H58.0875V12.9551Z" fill="black" />
                    <path d="M58.0875 0.146973H50.314V8.20239H58.0875V0.146973Z" fill="black" />
                    <path
